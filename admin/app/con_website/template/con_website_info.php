...
<form id="form1" name="form1" method="post" action="">
	 ...
	 <tr>
		<th colspan="2" align="left"><?php echo $type=='newedit' ? '修改' : '添加';?></th>
	</tr>
	<tr>
		<td class="label" width="15%">分类:</td>
		<td width="85%">
		<select name="cat_id" id="cat_id" onchange="showdiv(this.value)">
		<?php 
		if(!empty($catids)){
    ...
    <td>
	  ...
	  <tr id="showtr" <?php echo !isset($rt['cat_id'])||$rt['cat_id']!=32 ? 'style="display:none"' : ""; ?>>
		<td class="label">重要套餐优化:</td>
		<td><textarea name="packet" id="about" style="width: 60%; height: 65px; overflow: auto;"><?php echo isset($rt['packet']) ? $rt['packet'] : '';?></textarea>提醒：<em>一条一行哦？！</em></td>
	  </tr>
  	 </tr>
	  <tr>
...
//jQuery(document).ready(function($){
	...
	function showdiv(objvar){ 
		obj=document.getElementById('showtr');
		if(objvar==32){
