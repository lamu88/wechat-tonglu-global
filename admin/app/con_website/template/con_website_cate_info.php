...
<table cellspacing="2" cellpadding="5" width="100%">
	 <tr>
		<th colspan="2" align="left"><?php echo $type=='cateedit' ? '修改' : '添加';?>网站建设分类</th>
	</tr>
	<tr>
  ...
  <tr>
    <td colspan="2" align="center"><br>
	  <input name="type" value="web" type="hidden" class="types">
