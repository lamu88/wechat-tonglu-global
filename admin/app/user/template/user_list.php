...
<div class="contentbox">
	 ...
	 <tr>
		<th colspan="7" align="left"><span style="float:left">会员列表</span><a href="<?php echo ADMIN_URL;?>user.php?type=info" style="float:right; padding:3px; background:#ededed; border-bottom:2px solid #ccc; border-right:2px solid #ccc; color:#00ab36">添加会员</a></th>
	</tr>
	<tr><td colspan="7" align="left">
		...
		ID <input name="keywordID" size="15" type="text" value="<?php echo isset($_GET['keywordID']) ? $_GET['keywordID'] : "";?>">
    	<input value=" 搜索 " class="cate_searchID" type="button">
	</td></tr>
    <tr>
	   <th width="25"><label><input type="checkbox" class="quxuanall" value="checkbox" />编号</label></th>
	   <th width="25">ID</th>
 ...
 $('.quxuanall').click(function (){
  ...
  //批量删除
   ...
   $('.deluserid').click(function(){
	...
	$('.cate_searchID').click(function(){
		
		keys = $('input[name="keywordID"]').val();
		
		location.href='<?php echo Import::basic()->thisurl();?>&keywordID='+keys;
	});
</script>