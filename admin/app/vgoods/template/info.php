...
<form action="" method="post" enctype="multipart/form-data" name="theForm" id="theForm">
 <div class="menu_content">
	 ...
	 <table cellspacing="2" cellpadding="5" width="100%" id="tab1">
	  <tr>
		<th colspan="8" align="left"><span style="float:left">虚拟商品</span><a href="<?php echo ADMIN_URL.'vgoods.php?type=lists';?>" style="float:right; padding:2px 4px 2px 4px; background:#ededed; border-bottom:2px solid #ccc; border-right:2px solid #ccc">返回商品列表</a></th>
	  </tr>
	  <tr>
		<td class="label">商品名称：</td>
		<td>
		<input name="goods_name" id="goods_name"  type="text" size="50" value="<?php echo isset($rt['goods_name']) ? $rt['goods_name'] : '';?>"><span style="color:#FF0000">*</span><span class="goods_name_mes"></span>
		</td>
	  </tr>
	  ...
	  <tr>
            ...
            <td>
			<input name="goods_unit" value="<?php echo isset($rt['goods_unit']) ? $rt['goods_unit'] : '';?>" size="23" type="text" />
			<b>商品编号:</b><input name="goods_bianhao" id="goods_bianhao"  type="text" size="20" value="<?php echo isset($rt['goods_bianhao']) ? $rt['goods_bianhao'] : '';?>">
			</td>
        </tr>
<!--		<tr>
            <td class="label">卡账号：</td>
            <td>
			<input name="goods_sn" id="goods_sn"  type="text" size="23" value="<?php echo isset($rt['goods_sn']) ? $rt['goods_sn'] : '';?>">
			<b>卡&nbsp;密&nbsp;码：</b><input name="need_jifen" value="<?php echo isset($rt['need_jifen']) ? $rt['need_jifen'] : '';?>" size="20" type="text" />
			</td>
        </tr>-->
	
	<tr>
            <td class="label">商品库存数量：</td>
            <td><input name="goods_number" value="<?php echo isset($rt['goods_number']) ? $rt['goods_number'] : '10';?>" size="23" type="text" />
