...
<form action="" method="post" enctype="multipart/form-data" name="theForm" id="theForm">
 ...
 <div class="menu_content">
	...
	<tr>
            ...
            <td><input name="goods_number" value="<?php echo isset($rt['goods_number']) ? $rt['goods_number'] : '100000';?>" size="20" type="text" /></td>
          </tr>
	<tr>
           <td class="label">升级产品：</td>
           <td>
		   <select name="up_goods">
				<option value ="0"<?php if($rt['up_goods']==0) echo " selected = 'selected'"; ?>>无升级属性</option>
				<option value ="1"<?php if($rt['up_goods']==1) echo " selected = 'selected'"; ?>>黄金等级</option>
				<option value ="2"<?php if($rt['up_goods']==2) echo " selected = 'selected'"; ?>>白金等级</option>
				<option value ="3"<?php if($rt['up_goods']==3) echo " selected = 'selected'"; ?>>钻石等级</option>
		   </select>
		   </td>
     </tr>
          <tr>
	 ...
	 <select name="uid">
	  ...
	  <tr>
		...
		<b>实际价格:</b><input name="pifa_price" id="pifa_price"  type="text" size="13" value="<?php echo isset($rt['pifa_price']) ? $rt['pifa_price'] : '';?>">
		</td>
	  </tr>
	   <tr>
	...
	<tr>
	  <td class="label" style="color:#FF0000">总佣金(升级产品无效):</td>
