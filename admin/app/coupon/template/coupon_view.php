<div class="contentbox">
 ...
 <tr>
	 <th colspan="8" align="left" style="position:relative">红包列表<span style=" position:absolute; right:5px; top:3px"><a href="coupon.php?type=list">返回红包类型</a></span></th>
</tr>
<tr>
 	<th>编号</th><th>发放名称</th><th>红包序列号</th><th>红包类型</th><th>订单号</th><th>使用会员</th><th>使用时间</th><th>操作</th>
</tr>
<?php
