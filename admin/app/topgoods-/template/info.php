...
<?php } ?>
 ...
 <?php 
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							<td><input type="text" name="photo_name[]" value="<?php echo isset($rt['gname']) ? $rt['gname'] : '';?>" style="width:280px"/></td>
						</tr>
						<tr>
						<td class="label" valign="top">链接</td>
						<td> <input type="text" name="photo_url[]" value="<?php echo isset($rt['url']) ? $rt['url'] : '';?>" style="width:280px"/></td>
						</tr>
						<tr>
    ...
    <td class="label" style="text-align:left">
	 ...
	 </select>&nbsp;&nbsp;&nbsp;<input value=" 马上操作 " type="Submit" style="cursor:pointer; padding:2px; color:#FF0000">
    </td>
  </tr>
	 </table>
	 </form>
