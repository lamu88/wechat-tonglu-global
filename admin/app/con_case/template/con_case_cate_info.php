...
<table cellspacing="2" cellpadding="5" width="100%">
	 <tr>
		<th colspan="2" align="left">品牌预告时间</th>
	</tr>
	<tr>
    <td class="label">日期:</td>
    <td><input name="cat_name" id="cat_name" onClick="WdatePicker()"  maxlength="60" size="30" value="<?php echo isset($rt['cat_name']) ? $rt['cat_name'] : '';?>" type="text"><span class="require-field">*</span><span class="cat_name_mes"></span></td>
  </tr>
    <tr>
  ...
  <tr>
    <td colspan="2" align="center"><br>
	  <input name="type" value="case" type="hidden" class="types">
