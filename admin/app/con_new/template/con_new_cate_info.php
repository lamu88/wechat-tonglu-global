...
<table cellspacing="2" cellpadding="5" width="100%">
	 <tr>
		<th colspan="2" align="left"><span style="float:left"><?php echo $type=='cateedit' ? '修改' : '添加';?>新闻分类</span><span style="float:right"><a href="con_new.php?type=catelist">返回分类列表</a></span></th>
	</tr>
	<tr>
  ...
  <tr>
    <td colspan="2" align="center"><br>
	  <input name="type" value="new" type="hidden" class="types">
