...
<table cellspacing="2" cellpadding="5" width="100%">
	 <tr>
		<th colspan="2" align="left"><span style=" float:left"><?php echo $type=='cateedit' ? '修改' : '添加';?>系统默认分类</span><a href="con_default.php?type=catelist" style="float:right">返回分类列表</a></th>
	</tr>
	<tr>
  ...
  <!--
	  ...
	  <tr class="showimg">
	  	<td class="label">分类图标预览：</td>
		<td>
		<img src="../<?php echo $rt['cat_img'];?>" alt="分类图标预览" width="100"/>
		</td>
	  </tr>
	  <?php } ?>
	  <tr>
  ...
  <tr>
    <td colspan="2" align="center"><br>
	  <input name="type" value="about" type="hidden" class="types">
