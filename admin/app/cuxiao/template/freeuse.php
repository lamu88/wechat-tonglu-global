...
<div class="contentbox">
	 ...
	 <tr>
		<th colspan="7" align="left">免费试用产品<a href="<?php echo ADMIN_URL.'cuxiao.php?type=freeuse_info';?>" style="float:right">添加产品</a></th>
	</tr>
    <tr>
	...
	<td>
	<a href="cuxiao.php?type=freeuse_info&id=<?php echo $row['id'];?>" title="编辑"><img src="<?php echo $this->img('icon_edit.gif');?>" title="编辑"/></a>&nbsp;
	<a href="cuxiao.php?type=freeuse&id=<?php echo $row['id'];?>" title="删除" onclick="return confirm('确定删除吗')"><img src="<?php echo $this->img('icon_drop.gif');?>" title="删除" alt="删除" id="<?php echo $row['id'];?>" /></a>
	</td>
	</tr>
	<?php } ?>
	<tr>
