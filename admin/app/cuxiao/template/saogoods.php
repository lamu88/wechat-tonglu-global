...
<div class="contentbox">
	 ...
	 <tr>
		<th colspan="8" align="left">扫码商品列表<a href="<?php echo ADMIN_URL.'cuxiao.php?type=saogoods_info';?>" style="float:right">添加产品</a></th>
	</tr>
    <tr>
	...
	<td><?php echo !empty($row['url']) ? '<img src="'.$row['url'].'" width="100"/>' : '无图标';?></td>
	<td><?php echo $row['nickname'];?></td>
	<td><?php echo $row['goods_name'];?></td>
<td><?php echo !empty($row['goods_thumb']) ? '<img src="../'.$row['goods_thumb'].'" width="100"/>' : '无图标';?></td>
	<td><?php echo date('Y-m-d',$row['time']);?></td>
	<td>
	<a href="cuxiao.php?type=saogoods_info&id=<?php echo $row['id'];?>" title="编辑"><img src="<?php echo $this->img('icon_edit.gif');?>" title="编辑"/></a>&nbsp;
	</td>
	</tr>
	<?php } ?>
	<tr>
