...
<form id="form1" name="form1" method="post" action="">
	...
	<tr>
	  ...
	  <tr>
		<td class="label" width="150">条件:</td>
		<td><input name="title" size="50" value="<?php echo isset($rt['ucount']) ? $rt['ucount'] : 0'';?>" type="text"><span class="require-field">转发多少个成为粉丝</span>
		</td>
	  </tr>
